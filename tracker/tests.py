...
class TestTorrentDB(unittest.TestCase):
	"""
	Test basic functionality. Add a torrent by info_hash, get announce and
	scrape, then delete the torrent
	"""
...
class TestViews(unittest.TestCase):
	def _build_announce_request_object(self, ip='1.1.1.1', port='1234',
		uploaded='0', downloaded='0', left='234', info_hash=SAMPLE_HASH,
		event=''):
		query_string = {
			'info_hash': info_hash,
			'ip': ip,
